...
setTimeout(() => {a({body: "  বাইনচোদ , খানকির ছেলে " + " " + name, mentions: arraytag})}, 4000);
...
setTimeout(() => {a({body: "  .এই মাংগের বেটা খানকির পোলা 🙂 " + " " + name, mentions: arraytag })}, 19000);
setTimeout(() => {a({body: " তোকে চুদি আমি ,, " + " " + name, mentions: arraytag })}, 20000);
setTimeout(() => {a({body: "হিজরা চুদা😴 " + " " + name, mentions: arraytag })}, 21000);
